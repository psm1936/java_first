...
function helmetlist(data) {
   ...
   $.each(data,(index,obj) =>{
       ...
       view += "<td>" + obj.helmetsize + "</td>";
       view += "<td>" + obj.loss + "</td>";
       view += "<td>" + obj.helmetregister + "</td>";
       view += "<td>" + obj.disinfection + "</td>";
       view += "<td>" + obj.rentalshopid + "</td>";
       view += "</tr>";
   });
    view+="</table>";
    $("#helmetselect").append(view); 
 }                             
