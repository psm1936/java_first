...
var rentalshopid='${sessionScope.rentalshopVO.rentalshopid}';

function rentalshoplistFn(){
      $.ajax({
         url : "rentalshoplist.go",
         type : "get",
         data : { "rentalshopid" : rentalshopid},
         success : rentalshoplist,
         dataType : "json",
         error : function() {
            alert("errorrentalshoplist");
         }
      });
   }

function rentalshoplist(data) {
      ...
      $.each(data,(index,obj) =>{
          view += "<tr>";
          view += "<td>" + obj.rentalshopname + "</td>";
          view += "<td>" + obj.rentalshopaddress + "</td>";
          view += "<td>" + obj.latitude + "</td>";
          view += "<td>" + obj.longitude + "</td>";
          view += "<td>O</td>";
          view += "</tr>";
      });
       view+="</table>";
							...
							<div class="form-row tm-search-form-row">
								<div
									...
									<button type="button"
										...
										id="btnwatch" onclick="rentalshoplistFn()">추가</button>
								</div>
							</div>
						</form>
